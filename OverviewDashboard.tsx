...
export const OverviewDashboard: React.FC<OverviewDashboardProps> = ({
  ...
  const totalSpendRp = HISTORICAL_ODCS.reduce((acc, curr) => acc + curr.totalCostRp, 0);
  const totalLeakageRp = EXTRA_COSTS.filter((e) => e.chargeStatus === 'UNBILLED_LEAKAGE').reduce(
